# Feature Specification — C-USB-008 — External storage & surprise-removal awareness

## 3. Identificação

Nome: External storage & surprise-removal awareness
ID: C-USB-008
...
**Base conceitual do Discovery:** [26] External Storage Safe Removal & Surprise Removal Awareness — `CANDIDATE`
...
Evita decisões baseadas em suposição sobre **External storage & surprise-removal awareness**, modelando estado real, contexto, limitações e falhas antes de qualquer recomendação ou ação.
...
### Fonte da verdade
Primary truth is the documented Windows/API state closest to the subsystem being modeled for External storage & surprise-removal awareness; secondary sources may enrich context but must carry provenance/confidence. Vendor data is authoritative only for vendor-defined telemetry on explicitly supported hardware.
...
## 8. Estado alvo
A normalized, provenance-aware assessment of **External storage & surprise-removal awareness** with explicit Supported/Partial/Unknown/Not Applicable states and no persistent system change.
...
Target state: A normalized, provenance-aware assessment of **External storage & surprise-removal awareness** with explicit Supported/Partial/Unknown/Not Applicable states and no persistent system change.
Changes:
...
### Script/protótipo
Local: `/prototypes/usb/c-usb-008/` — **TBD / ainda não executado nesta fase documental**.
...
- Prova prática adicional essencial: Sim — external-storage surprise removal/flush awareness.
- Evidência realmente executada: NENHUMA.
- Execução segura neste host / teste: Sim só para detectar ausência de disco USB.
- Impedimento ou limitação restante: Não há armazenamento USB externo, nem cenário de removal seguro.
