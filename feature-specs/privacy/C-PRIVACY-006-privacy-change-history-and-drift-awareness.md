# Feature Specification — C-PRIVACY-006 — Privacy change history & drift awareness
...
**Base conceitual do Discovery:** [15] Privacy Recommendation Explanation — `CANDIDATE`; [19] Privacy Change History — `CANDIDATE`; [20] Privacy Recommendation Confidence — `CANDIDATE`
...
Evita decisões baseadas em suposição sobre **Privacy change history & drift awareness**, modelando estado real, contexto, limitações e falhas antes de qualquer recomendação ou ação.
...
### Fonte da verdade
Primary truth is the documented Windows/API state closest to the subsystem being modeled for Privacy change history & drift awareness; secondary sources may enrich context but must carry provenance/confidence. Vendor data is authoritative only for vendor-defined telemetry on explicitly supported hardware.
...
## 8. Estado alvo
A normalized, provenance-aware assessment of **Privacy change history & drift awareness** with explicit Supported/Partial/Unknown/Not Applicable states and no persistent system change.
...
```text
Feature: C-PRIVACY-006
Current state: normalized Detect result + provenance
Target state: A normalized, provenance-aware assessment of **Privacy change history & drift awareness** with explicit Supported/Partial/Unknown/Not Applicable states and no persistent system change.
Changes:
...
### Script/protótipo
Local: `/prototypes/privacy/c-privacy-006/` — **TBD / ainda não executado nesta fase documental**.
