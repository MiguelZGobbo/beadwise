...
bcb3cdc docs(discovery): finalize capability review
b76249e docs(discovery): consolidate capability catalogs
41e07ab docs(discovery): add remaining capability catalogs
```
...
- `repair.component-store-check` — FAIL: DISM exit code 740:  Erro: 740  Permiss�es elevadas obrigat�rias para execu��o do DISM.  Use um prompt de comandos com privil�gios elevados para concluir estas tarefas. 
